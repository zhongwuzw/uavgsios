...
@property (nonatomic,strong) BarController* CUS_BarController;

@property (nonatomic, strong) NSTimer *liveBroadTimer;
@property (nonatomic, strong) LiveBroadView *liveBroadView;
...
@property (nonatomic, strong) NSMutableArray *GPMediaArray;
@property (nonatomic, strong) UIPopoverController *photoPopViewController;
